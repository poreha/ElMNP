...
void RedGauss(){
//	TH1D *h1 = new TH1D("h1","RNGauss 1",70,-7,7);
...
//заполнение первых трех палетов случайным распр Гаусса	
	...
	c1.cd(2);
	TH1D *h2 = new TH1D("h2","RNGauss 2",70,-7,7);
	char *axis_title = "x, cm";
	...
	c1.cd(3);
	TH1D *h3 = new TH1D("h3","RNGauss 3",70,-7,7);
	char *axis_title = "x, cm";
...
//зарисовка двух распределений на одном палете
	c1.cd(4);
	TH1D *h4 = new TH1D("h4","RNGauss 3&4",70,-7,7);
...
//создание 2х-мерной гистограммы
	c1.cd(5);
//	TH2D *h5 = new TH2D("h5","2D",70,-7,7,70,-7,7);
